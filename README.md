# The present work aims to demonstrate the potential of creating a neural network to predict the total organic content (TOC) based on the XRF results of cutting samples from a hydrocarbon source rock.
